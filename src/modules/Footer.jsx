...
export const Footer = () => {
	const { categories, productsRef } = useProducts();
					...
					<ul className="footer__menu">
						{Object.entries(categories).map(([key, value]) => (
							<li key={key} className="footer__menu-item">
								<Link
									className={`footer__menu-link ${getActiveClass(
										key
									)}`}
				...
				<div className="footer__contacts">
					...
					<ul className="footer__social">
						<li className="footer__social-item">
							<a className="footer__social-link" href="#!" aria-label='канал в телеграмм'>
								<svg
									width="32"
									height="32"
									viewBox="0 0 32 32"
						...
						<li className="footer__social-item">
							<a className="footer__social-link" href="#!" aria-label="группа вконтакте">
								<svg
									width="32"
									height="32"
									viewBox="0 0 32 32"
